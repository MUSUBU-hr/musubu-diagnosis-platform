...
// ========================================
const QUESTIONS = [
  // --- Block 1（リーダー×2 サポーター×1 アナリスト×2 クリエイター×1 スペシャリスト×2 チャレンジャー×2）---
  { id: 1,  text: 'あなたは人と話すことが好きですか？' },             // supporter
  { id: 12, text: '締め切りを守ることは当然と思いますか？' },          // specialist
  { id: 2,  text: '初対面の人とも自然に会話が弾む方ですか？' },        // leader
  { id: 41, text: '変化の多い環境が好きですか？' },                    // challenger
  { id: 11, text: '計画を立てて物事を進めることが得意ですか？' },       // analyst
  { id: 19, text: '新しいやり方を試してみることが好きですか？' },       // creator
  { id: 43, text: '一つのことを深く極めていきたいですか？' },           // specialist
  { id: 5,  text: '人前でのスピーチや発表が得意ですか？' },            // leader
  { id: 28, text: '失敗を学びの機会として前向きに捉えられますか？' },   // challenger
  { id: 22, text: '原因を分析してから行動することが多いですか？' },     // analyst

  // --- Block 2（リーダー×2 サポーター×1 アナリスト×1 クリエイター×2 スペシャリスト×2 チャレンジャー×2）---
  { id: 14, text: '細かいミスを見つけるのが得意ですか？' },             // analyst
  { id: 7,  text: '自分の意見をはっきり伝えることが得意ですか？' },     // leader
  { id: 23, text: 'アイデアを出すのが得意ですか？' },                   // creator
  { id: 15, text: '決められたルールに従って仕事をすることが苦になりませんか？' }, // specialist
  { id: 3,  text: 'チームで一緒に仕事をすることが好きですか？' },       // supporter
  { id: 9,  text: '顧客や取引先と直接やり取りすることが好きですか？' }, // challenger
  { id: 40, text: '自分のアイデアを形にできる仕事が好きですか？' },     // creator
  { id: 35, text: '自分のスキルを常に高めていきたいですか？' },          // specialist
  { id: 8,  text: '会議や打ち合わせが好きですか？' },                   // leader
  { id: 30, text: '予期せぬ出来事にも柔軟に対応できますか？' },         // challenger

  // --- Block 3（リーダー×2 サポーター×1 アナリスト×2 クリエイター×1 スペシャリスト×2 チャレンジャー×2）---
  { id: 29, text: '仮説を立てて検証するプロセスが好きですか？' },       // analyst
  { id: 25, text: '物事の全体像を把握してから動く方ですか？' },         // leader
  { id: 10, text: '知らない人の多い環境でも楽しめますか？' },           // challenger
  { id: 18, text: '一人で黙々と作業することが好きですか？' },           // specialist
  { id: 26, text: '直感で判断することが多いですか？' },                 // creator
  { id: 4,  text: '人の悩みを聞くのが得意ですか？' },                   // supporter
  { id: 13, text: '複数の仕事を同時に進めることが得意ですか？' },       // challenger
  { id: 32, text: '高い収入を得ることに強い関心がありますか？' },        // leader
  { id: 16, text: 'データや数字を扱うのが好きですか？' },               // analyst
  { id: 20, text: '完璧を追求することが多いですか？' },                 // specialist

  // --- Block 4（リーダー×1 サポーター×2 アナリスト×2 クリエイター×2 スペシャリスト×2 チャレンジャー×1）---
  { id: 21, text: '問題が起きたときに冷静に対処できますか？' },         // analyst
  { id: 37, text: 'クリエイティブな仕事に魅力を感じますか？' },          // creator
  { id: 6,  text: '人の気持ちをすぐに察することができますか？' },        // supporter
  { id: 42, text: '屋外での活動が好きですか？' },                       // challenger
  { id: 27, text: '複雑な情報を整理して分かりやすく伝えることが得意ですか？' }, // analyst
  { id: 33, text: '自分のペースで働けることを重視しますか？' },          // specialist
  { id: 31, text: '社会の役に立っていると感じられる仕事がしたいですか？' }, // supporter
  { id: 34, text: '責任ある立場で働きたいですか？' },                   // leader
  { id: 44, text: '多様な分野に興味を持っていますか？' },               // creator
  { id: 36, text: '安定した環境で長く働きたいですか？' },               // specialist

  // --- Block 5（リーダー×2 サポーター×1 アナリスト×1 クリエイター×2 スペシャリスト×2 チャレンジャー×2）---
  { id: 39, text: '競争のある環境でこそ力が発揮できますか？' },         // leader
  { id: 17, text: '書類や資料の整理が得意ですか？' },                   // analyst
  { id: 47, text: '新しい場所に行くことが好きですか？' },               // challenger
  { id: 38, text: '人の成長をサポートすることにやりがいを感じますか？' }, // supporter
  { id: 46, text: '目に見える成果物を作ることが好きですか？' },          // creator
  { id: 24, text: '難しい問題を解くことにやりがいを感じますか？' },      // specialist
  { id: 45, text: '自分で判断して動くことが多いですか？' },              // leader
  { id: 50, text: '今の自分を変えたいという気持ちが強いですか？' },      // challenger
  { id: 48, text: '仕事でも遊び心を大切にしたいですか？' },             // creator
  { id: 49, text: '長期的な目標に向かって努力することが得意ですか？' },  // specialist
];
